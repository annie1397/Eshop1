...
<div id="shopping-cart">
    ...
    <a id="btnEmpty" href="eshop.php?action=empty">Άδειασμα
        <a id="btnEmpty" href="kalathi.php?action=empty">oloklirosi</a>
    <?php
        ...
        <table class="tbl-cart" cellpadding="10" cellspacing="1">
            ...
            foreach ($_SESSION["cart_item"] as $item) {
                ...
                <tr>
                    ...
                    <td style="text-align:center;"><a href="eshop.php?action=remove&id=<?php echo $item["id"]; ?>"
            ...
            <div class="container1">
                <div class="picture">
                    ...
                    <div class="product-item">
                        <form method="post"
                              action="eshop.php?action=add&id=<?php echo $product_array[$key]["id"]; ?>">
                            <div class="product-image"><img src="<?php echo $product_array[$key]["image"]; ?>"></div>
                            <div class="product-tile-footer">
                                <div class="product-title"><?php echo $product_array[$key]["name"]; ?></div>
                                <div class="product-price"><?php echo "€" . $product_array[$key]["price"]; ?></div>
                                <div class="cart-action"><input type="text" class="product-quantity" name="quantity" value="1" size="2"/><input type="submit" value="Προσθήκη στο καλάθι" class="btnAddAction"/></div>
